function  new_Path_selecting_table = DP_path_generating_Multi(u_candidate,Path_selecting_List,parameters_hat,M,V,factor)
global n_sensor
...
for i =1:n_size
    ...
    for j=1:V
        ...
        new_Path_selecting_element.FIM_current = FIM_computation_discount_Multi( Path_selecting_element.FIM_current, parameters_hat, x_next,factor);
