function y_current_observation = get_sig_observation_multi(x_current_position,real_parameters)
global sigma
global n_sensor
...
y_current_observation_elemt =  sig_observation(x_D,x_U,gamma,K,sigma(i));
